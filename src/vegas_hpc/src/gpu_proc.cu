             ...
             int acc_len)
{
    ...
    /* calculate the amount of actual data in the block */
...
void read_gpu_input_data()
{
    ...
    if ((g_pc4DataRead_d - g_pc4Data_d) * sizeof(char4) == g_iBlockInDataSize)
    {
        g_is_proc_done = 1;
    }
